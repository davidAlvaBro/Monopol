...
//					MainAc.title = Title.SetForSale;
				...
				}else if(mx >= MainAc.width/6 + MainAc.width*26/64 + MainAc.width*3/64 && mx <= MainAc.width/6 + MainAc.width*26/64 + MainAc.width*3/64 + MainAc.width*3/48 && my >= MainAc.height/4 + 2 * MainAc.height/16 && my <= MainAc.height/4 + MainAc.height/32 + 2 * MainAc.height/16){
					if(AI.amountOfAIs < Player.typedAmountOfPlayers){
						AI.amountOfAIs++;
					}
				}else if(mx >= MainAc.width/6 + MainAc.width*26/64 + MainAc.width*3/64 && mx <= MainAc.width/6 + MainAc.width*26/64 + MainAc.width*3/64 + MainAc.width*3/48 && my >= MainAc.height/4 + MainAc.height/32 + 2 * MainAc.height/16 && my <= MainAc.height/4 + MainAc.height/32 + MainAc.height/32 + 2 * MainAc.height/16){
					if(AI.amountOfAIs > 0){
						AI.amountOfAIs--;
					}
				} 
