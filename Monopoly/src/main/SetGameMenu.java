...
public class SetGameMenu {
	...
	public void render(Graphics g){
		...
		g.drawRect(MainAc.width/6, MainAc.height/4 + 2 * MainAc.height/16, MainAc.width*26/64, MainAc.height/16);
		g.setFont(textFont);
		g.drawString("How many AI's would you like?", MainAc.width/6 + 10, MainAc.height/4 + 40 + 2 * MainAc.height/16);
		
		g.drawRect(MainAc.width/6 + MainAc.width*26/64 , MainAc.height/4 + 2 * MainAc.height/16, MainAc.width*3/64, MainAc.height/16);
		g.drawString("" + AI.amountOfAIs, MainAc.width/6 + MainAc.width*26/64 + 22, MainAc.height/4 + 40 + 2 * MainAc.height/16);
		g.drawRect(MainAc.width/6 + MainAc.width*26/64 + MainAc.width*3/64, MainAc.height/4 + 2 * MainAc.height/16, MainAc.width*3/48, MainAc.height/32);
		g.drawRect(MainAc.width/6 + MainAc.width*26/64 + MainAc.width*3/64, MainAc.height/4 + MainAc.height/32 + 2 * MainAc.height/16, MainAc.width*3/48, MainAc.height/32);
		g.setFont(moreLessFont);
		g.drawString("More", MainAc.width/6 + MainAc.width*26/64 + MainAc.width*3/64 + 5, MainAc.height/4 + 24 + 2 * MainAc.height/16);
		g.drawString("Less", MainAc.width/6 + MainAc.width*26/64 + MainAc.width*3/64 + 5, MainAc.height/4 + MainAc.height/32 + 24 + 2 * MainAc.height/16);
